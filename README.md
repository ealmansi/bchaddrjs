...
You may also download the distribution file manually and place it within your third-party scripts directory: [dist/bchaddrjs-0.4.5.min.js](https://unpkg.com/bchaddrjs@0.4.5/dist/bchaddrjs-0.4.5.min.js).
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/bchaddrjs@0.4.5/dist/bchaddrjs-0.4.5.min.js"></script>
  </head>
  ...
</html>
```
