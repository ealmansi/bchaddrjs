...
You may also download the distribution file manually and place it within your third-party scripts directory: [dist/bchaddrjs-0.3.0.min.js](https://cdn.rawgit.com/bitcoincashjs/bchaddrjs/master/dist/bchaddrjs-0.3.0.min.js).
...
<html>
  <head>
    ...
    <script src="https://cdn.rawgit.com/bitcoincashjs/bchaddrjs/master/dist/bchaddrjs-0.3.0.min.js"></script>
  </head>
  ...
</html>
```
