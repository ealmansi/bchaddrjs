...
You may also download the distribution file manually and place it within your third-party scripts directory: [dist/bchaddrjs-0.4.0.min.js](https://unpkg.com/bchaddrjs@0.4.0/dist/bchaddrjs-0.4.0.min.js).
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/bchaddrjs@0.4.0/dist/bchaddrjs-0.4.0.min.js"></script>
  </head>
  ...
</html>
```
